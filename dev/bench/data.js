    ...
    "Component benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b3ee0a21b90a603662acc8ffeabeef1ffc0f47c4",
          "message": "Update SDK and tracing (#194)\n\n<!-- The PR description should answer 2 (maybe 3) important questions:\n-->\n\n### What\n* Update sdk to 0.5.0\n* Add visibility user to tracing spans",
          "timestamp": "2025-07-30T10:26:51-06:00",
          "tree_id": "8aa87bec324abd376b5a447a3b55173a22a1381d",
          "url": "https://github.com/hasura/ndc-sqlserver/commit/b3ee0a21b90a603662acc8ffeabeef1ffc0f47c4"
        },
        "date": 1753892954825,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 53.515568220180235,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 0.46448564376125745,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.05959890795593761,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - p(95)",
            "value": 403.18448620000004,
            "unit": "ms"
          },
          {
            "name": "select-variables - connection acquisition time",
            "value": 370.76908601076883,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 0.849810887485944,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.06586124210868288,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 124.86089067790326,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 0.4821393150997437,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.05801354840320189,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - p(95)",
            "value": 143.89199059999999,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 125.50050542540619,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 0.5379537208358727,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.058382618005215776,
            "unit": "ms"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "962dc601b9f2b07d05087e3fd13c1504cb17a18b",
          "message": "Release v2.0.2 (#195)\n\n<!-- The PR description should answer 2 (maybe 3) important questions:\n-->\n\n### What\n\nRelease v2.0.2",
          "timestamp": "2025-07-30T10:52:28-06:00",
          "tree_id": "8d1c137797c7dcec3002e92e87705e7edbc313c2",
          "url": "https://github.com/hasura/ndc-sqlserver/commit/962dc601b9f2b07d05087e3fd13c1504cb17a18b"
        },
        "date": 1753894472898,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 56.94111002470233,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 0.5659085960218277,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.06908783031143753,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
            "value": 387.25728300000003,
            "unit": "ms"
          },
          {
            "name": "select-variables - p(95)",
          ...
          {
            "name": "select-variables - connection acquisition time",
            "value": 374.44640048383457,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 0.9240521898494762,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.07446059360823684,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 125.31406865291807,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 0.5351043944577043,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.062402996680022985,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - connection acquisition time",
            "value": 137.6362386739952,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 0.6770096227421334,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.06483804607231788,
            "unit": "ms"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c6f9535f96195c33a46f27aa809fc9f91a2e57d1",
          "message": "Update action runners",
          "timestamp": "2025-07-30T13:00:51-06:00",
          "tree_id": "b703fba99e865c76792fd0a4a9d3796a632f54e5",
          "url": "https://github.com/hasura/ndc-sqlserver/commit/c6f9535f96195c33a46f27aa809fc9f91a2e57d1"
        },
        "date": 1753902225777,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 53.80194717978963,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 0.47619850786276174,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.06077592746415697,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - connection acquisition time",
            "value": 364.02680432076176,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 0.9003831058227547,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.06608324313434273,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - p(95)",
            "value": 141.24583239999998,
            "unit": "ms"
          },
          {
            "name": "select-where - connection acquisition time",
            "value": 123.73409695184641,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 0.5037338023446694,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.05729054783844485,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - p(95)",
            "value": 143.21793799999998,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 126.31080309774619,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 0.5581124771410657,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
